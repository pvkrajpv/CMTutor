...
public final class Yin implements PitchDetector {
	 ...
	 */
	public Yin(final float audioSampleRate, final int bufferSize, int windowLength,  int windowShift) {
		this(audioSampleRate, bufferSize, DEFAULT_THRESHOLD,windowLength,windowShift);
	}
	 ...
	 */
	public Yin(final float audioSampleRate, final int bufferSize, final double yinThreshold,final int windowLength, final  int windowShift) {
		this.sampleRate = audioSampleRate;
		this.threshold = yinThreshold;
		this.windowLength = windowLength;
		this.windowShift = windowShift;
		yinBuffer = new float[windowLength / 2];
	...
	public PitchDetectionResult getPitch(float[] audioBuffer) {
		...
		float[] newBuffer = new float[this.windowLength];
